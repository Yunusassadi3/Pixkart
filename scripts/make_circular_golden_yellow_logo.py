...
def create_circular_golden_yellow_logo():
    ...
    # 2. Build high-resolution 1024x1024 circular golden-yellow frame
    canvas_size = 1024
    ...
    # Golden-Yellow color: Rich vibrant warm gold (#FFBE0B / #FBBF24 / #F59E0B)
    # RGB: (254, 195, 20) -> #FEC314 (vibrant warm golden yellow)
    gold_color = (254, 195, 20, 255)
    draw.ellipse(circle_bbox, fill=gold_color)
    ...
    # 3. Position the emblem inside the golden-yellow circle (~78% of circle diameter)
    ...
    # Center the emblem inside the circular golden-yellow canvas
    paste_x = (canvas_size - target_inner_w) // 2
    paste_y = (canvas_size - target_inner_h) // 2

    # Composite emblem onto circular golden-yellow frame
    ...
    # 4. Save transparent PNG with circular golden-yellow frame
    ...
    print(f"Saved circular golden-yellow PNG: {out_icon_png} and {out_logo_png}")
    ...
    # 6. Save multi-size favicon.ico with circular golden-yellow frame
    ...
    print(f"Saved favicon.ico with circular golden-yellow frame: {fav_public_path}")
    ...
    print("Circular golden-yellow logo and favicon export complete!")

if __name__ == "__main__":
    create_circular_golden_yellow_logo()
